...
class Meal {
  ...
  List<Map<String, String>> get getIngredients {
    ...
    List<Map<String, String>> filteredIngredients = ingredients
        .where((ingredient) {
      String? key = ingredient.keys.first;
      String? value = ingredient.values.first;
      return key != null && key.isNotEmpty && value != null && value.isNotEmpty;
    })
        .map((ingredient) => {ingredient.keys.first!: ingredient.values.first!})
        .toList();
